...
class DotNet10DesktopRuntime(BaseSoftware):
    def __init__(self):
        super().__init__()

        self.key = 'dotnet-10-desktop-runtime'
        self.name = '.NET 10.0 Desktop Runtime'
        ...
        self.installer_id_pattern = compile(
            r'runtime-desktop-\d+\.\d+\.\d+-windows-x64-installer'
        )
    ...
    def resolve_download_url(self):
        self.manager.get(QNetworkRequest('https://dotnet.microsoft.com/en-us/download/dotnet/10.0'))
